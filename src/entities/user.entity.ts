...
export class User {
  ...
  @Column({ name: 'UserIsActive', type: 'boolean', nullable: true, default: () => 'true' })
  status?: boolean;
  ...
  @Column({ name: 'UserPreferredModeOfLearning', type: 'varchar', length: 100, nullable: true })
  ...
  @Column({ name: 'UserWhatDoYouWantToBecome', type: 'varchar', length: 200, nullable: true })
  ...
  @Column({ name: 'UserGuardianRelation', type: 'varchar', length: 100, nullable: true })
  ...
  @Column({ name: 'UserEnrollmentNumber', type: 'varchar', length: 100, nullable: true })
