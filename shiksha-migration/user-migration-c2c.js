...
async function migrateCoreUserData(sourceClient, destClient) {
  ...
  const usersQuery = `
    ...
    FROM public."Users" u
    INNER JOIN public."UserTenantMapping" utm ON u."userId" = utm."userId"
    WHERE utm."tenantId" IS NULL OR utm."tenantId" = 'fd8f3180-9988-495b-8a0d-ed201d7d28df' 
    AND DATE(u."createdAt") BETWEEN '2025-09-06' AND '2025-09-18';
  `;
